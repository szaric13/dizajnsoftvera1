...
public class SaveProjectAsTemplateAction extends AbstractGraffAction {
    public SaveProjectAsTemplateAction() {
        putValue(SMALL_ICON, loadIcon("/images/saveastemplate.png"));
        putValue(NAME, "Save as Template");
        putValue(SHORT_DESCRIPTION, "Save Project as Template");
        disable();
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        jacksonSerializer.saveProjectTemplate(project);
    }
